...
import com.example.sampledynamicfeature.databinding.ActivityDynamicFeatureBinding
...
class DynamicFeatureActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navController = findNavController(R.id.nav_host_fragment_content_dynamic_feature)
